...
describe('Product Controller', () => {
  ...
  describe('CRUD Operations for Products', () => {
    ...
    test('createProduct', () => {
      ...
      // act
      jest.spyOn(controller, 'createProduct')
    ...
    test('getCustomer', () => {
      ...
      // act
      jest.spyOn(controller, 'getProduct')
        .mockImplementation(() => expectedResult);
    ...
    test('updateProduct', () => {
      ...
      // act
      jest.spyOn(controller, 'updateProduct')
        .mockImplementation(() => expectedResult);
    ...
    test('deleteProduct', () => {
      ...
      // act
      jest.spyOn(controller, 'deleteProduct')
        .mockImplementation(() => expectedResult);
    ...
    test('getProducts', () => {
      ...
      // act
      jest.spyOn(controller, 'getProducts')
        .mockImplementation(() => expectedResult);
